    ...
    <div className="container mx-auto px-4">
      ...
      Your browser does not support the video tag.
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-700 mt-4">Founded in January 2024, Influenced by Souls is a dynamic and innovative platform that deeply impacts the lives of others.<br />From day one, we've been dedicated to fostering connections, providing support, and inspiring each other.<br /><br />In today's world, many people suffer from loneliness and a lack of genuine connections despite the technology that was supposed to connect us all. This is often due to a lack of authenticity and insecurities. That's why we've created this platform where everyone feels safe to be themselves and connect with others on a deeper level. Our platform is designed to rescue souls from isolation, guide them towards genuine connections and inspire others in the real world.<br />Join Influenced by Souls and embark on a journey of connection, support, and inspiration. Together, let's build a world where no one feels alone. <br /><br />Tcherno, <br />
